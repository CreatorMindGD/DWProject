...
public class LectureVideoController {
	...
	public String vidlist(@RequestParam("lec_id") String lecId,
	    ...
	    for (GrantedAuthority auth : authorities) {
	        ...
	        if ("ROLE_01".equals(role)) isStudent = true;
	        else if ("ROLE_02".equals(role)) isProfessor = true;
	    }
	    ...
	    if (isStudent) {
	        for (LecVideoVO video : list) {
	            ...
	            if (att != null) {
	                video.setProgress(Integer.parseInt(att.getProgress())); // VO에 주입
	            } else {
	...
	public String registerVideo(@ModelAttribute LecVideoVO vo, BindingResult result,
	    ...
	    List<LectureListVO> studentList = lectureListDAO.getStudentsByLecture("test123");
